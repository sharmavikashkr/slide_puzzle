...
/// {@endtemplate}
class JamCountdown extends StatefulWidget {
  /// {@macro jam_countdown}
  const JamCountdown({
    Key? key,
  ...
  @override
  State<JamCountdown> createState() => _JamCountdownState();
}

class _JamCountdownState extends State<JamCountdown> {
  ...
  Widget build(BuildContext context) {
    return AudioControlListener(
      ...
      child: BlocListener<JamPuzzleBloc, JamPuzzleState>(
...
/// {@template jam_countdown_seconds_to_begin}
/// Display how many seconds are left to begin the puzzle.
/// {@endtemplate}
@visibleForTesting
class JamCountdownSecondsToBegin extends StatefulWidget {
  /// {@macro jam_countdown_seconds_to_begin}
  const JamCountdownSecondsToBegin({
    Key? key,
  ...
  @override
  State<JamCountdownSecondsToBegin> createState() =>
      _JamCountdownSecondsToBeginState();
}

class _JamCountdownSecondsToBeginState extends State<JamCountdownSecondsToBegin>
...
/// {@template jam_countdown_go}
/// Displays a "Go!" text when the countdown reaches 0 seconds.
/// {@endtemplate}
@visibleForTesting
class JamCountdownGo extends StatefulWidget {
  /// {@macro jam_countdown_go}
  const JamCountdownGo({Key? key}) : super(key: key);

  @override
  State<JamCountdownGo> createState() => _JamCountdownGoState();
}

class _JamCountdownGoState extends State<JamCountdownGo>
