...
/// The animation builder of [JamShareDialog].
class JamShareDialogAnimatedBuilder extends StatelessWidget {
  const JamShareDialogAnimatedBuilder({
    Key? key,
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return builder(
          context,
          child,
          JamShareDialogEnterAnimation(animation as AnimationController),
        );
      },
      child: child,
    );
...
typedef MyTransitionBuilder = Widget Function(
  ...
  Widget? child,
  JamShareDialogEnterAnimation animation,
);

class JamShareDialogEnterAnimation {
  JamShareDialogEnterAnimation(this.controller)
