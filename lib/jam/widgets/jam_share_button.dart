...
/// {@template jam_twitter_button}
/// Displays a button that shares the Flutter Puzzle challenge
/// on Twitter when tapped.
/// {@endtemplate}
class JamTwitterButton extends StatelessWidget {
  /// {@macro jam_twitter_button}
  const JamTwitterButton({Key? key}) : super(key: key);

  String _twitterShareUrl(BuildContext context) {
    final shareText = context.l10n.jamSuccessShareText;
...
/// {@template jam_facebook_button}
/// Displays a button that shares the Flutter Puzzle challenge
/// on Facebook when tapped.
/// {@endtemplate}
class JamFacebookButton extends StatelessWidget {
  /// {@macro jam_facebook_button}
  const JamFacebookButton({Key? key}) : super(key: key);
...
/// {@template jam_share_button}
/// Displays a share button colored with [color] which
/// displays the [icon] and [title] as its content.
/// {@endtemplate}
@visibleForTesting
class JamShareButton extends StatefulWidget {
  /// {@macro jam_share_button}
  const JamShareButton({
    Key? key,
  ...
  @override
  State<JamShareButton> createState() => _JamShareButtonState();
}

class _JamShareButtonState extends State<JamShareButton> {
