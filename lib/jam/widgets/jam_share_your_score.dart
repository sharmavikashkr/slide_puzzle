...
/// {@template jam_share_your_score}
/// Displays buttons to share a score of the completed puzzle.
/// {@endtemplate}
class JamShareYourScore extends StatelessWidget {
  /// {@macro jam_share_your_score}
  const JamShareYourScore({
    Key? key,
    required this.animation,
  }) : super(key: key);

  /// The entry animation of this widget.
  final JamShareDialogEnterAnimation animation;
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayoutBuilder(
      ...
      child: (currentSize) {
        ...
        return Column(
          key: const Key('jam_share_your_score'),
            ...
            SlideTransition(
              ...
              child: Opacity(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      l10n.jamSuccessShareYourScoreTitle,
                      key: const Key('jam_share_your_score_title'),
                      textAlign: textAlign,
                    ...
                    SizedBox(
                      width: messageWidth,
                      child: Text(
                        l10n.jamSuccessShareYourScoreMessage,
                        key: const Key('jam_share_your_score_message'),
                        textAlign: textAlign,
