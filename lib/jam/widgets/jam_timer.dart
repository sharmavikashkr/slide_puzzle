...
/// {@endtemplate}
class JamTimer extends StatelessWidget {
  /// {@macro jam_timer}
  const JamTimer({
    Key? key,
    this.textStyle,
  ...
  Widget build(BuildContext context) {
    final secondsElapsed =
        context.select((JamPuzzleBloc bloc) => bloc.state.secondsToReset);
  ...
  String _getDurationLabel(Duration duration, BuildContext context) {
    return context.l10n.jamPuzzleDurationLabelText(
